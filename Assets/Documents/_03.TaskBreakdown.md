...
| # | Task | Loại | Ưu tiên | Ước tính |
|---|---|---|---|---|
| 3.1 | Implement `TileModel` | `[M]` | 🔴 | 0.5h |
| 3.2 | Implement `BoardModel` — khởi tạo | `[M]` | 🔴 | 1h |
| 3.3 | Implement `BoardModel.UpdateSelectableStatus()` + Raise EventBus | `[M]` | 🔴 | 2h |
| 3.4 | Implement `BoardModel.RemoveTile()` | `[M]` | 🔴 | 1h |
| 3.5 | Implement `BoardModel.ShuffleTileTypes()` | `[M]` | 🔴 | 1h |
...
| # | Task | Loại | Ưu tiên | Ước tính |
|---|---|---|---|---|
| 3.8 | Implement `StackModel` | `[M]` | 🔴 | 1h |
| 3.9 | Implement `StackModel.GetInsertIndex()` | `[M]` | 🔴 | 1h |
| 3.10 | Implement `StackModel.FindMatch()` | `[M]` | 🔴 | 1h |
...
| # | Task | Loại | Ưu tiên | Ước tính |
|---|---|---|---|---|
| 3.14 | Implement `GameStateModel` | `[M]` | 🔴 | 0.5h |
| 3.15 | Implement `TileHistoryModel` | `[M]` | 🔴 | 0.5h |
| 3.16 | Implement `PowerUpModel` | `[M]` | 🔴 | 1h |
| 3.17 | Implement `HeartsModel` | `[M]` | 🔴 | 1.5h |
| 3.18 | Implement `CoinsModel` | `[M]` | 🟡 | 0.5h |
| 3.19 | Implement `LevelModel` | `[M]` | 🔴 | 0.5h |
| 3.20 | Viết unit tests | `[T]` | 🔴 | 3h |
